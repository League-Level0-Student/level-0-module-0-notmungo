...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String bodyPart = JOptionPane.showInputDialog("Hand");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Jump");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Big Home");
		...
		"likely take a bite out of your [hand] if you "+bodyPart+". Whatever\n"  +
		"you do, if you have an open wound, try to find another way to get "+verb+" \n"  +
