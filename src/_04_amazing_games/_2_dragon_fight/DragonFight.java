	...
	int dragonHealth = 100;
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
				String code = JOptionPane.showInputDialog("Do you want to attack the dragon with a yell or a kick") ;
	        ...
	        JOptionPane.showMessageDialog(null, "The dragon removed " + dragonAttack + " from your health");
