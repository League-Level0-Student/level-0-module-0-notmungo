...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("pixelMaze-0.png"));
	...
	private void scare() {
		...
		if (canPlaySounds) {
			...
			// of your sound file
			playScarySound("269393_germantutorials_scary-wind(4).wav");
